# Comparing `tmp/duwi_smart_sdk-0.2.5.tar.gz` & `tmp/duwi_smart_sdk-0.2.6.tar.gz`
...
### Comparing `duwi_smart_sdk-0.2.5/duwi_smart_sdk/model/resp/floor.py` & `duwi_smart_sdk-0.2.6/duwi_smart_sdk/model/resp/floor.py`
