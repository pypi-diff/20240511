# Comparing `tmp/deepmimov3-0.1.tar.gz` & `tmp/deepmimov3-0.1.1.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "deepmimov3-0.1.tar", last modified: Fri May 10 23:31:42 2024, max compression
+gzip compressed data, was "deepmimov3-0.1.1.tar", last modified: Sat May 11 16:53:50 2024, max compression
```

## Comparing `deepmimov3-0.1.tar` & `deepmimov3-0.1.1.tar`

### file list

```diff
@@ -1,24 +1,24 @@
-drwxrwxrwx   0        0        0        0 2024-05-10 23:31:42.391155 deepmimov3-0.1/
--rw-rw-rw-   0        0        0      441 2024-05-10 23:31:42.390159 deepmimov3-0.1/PKG-INFO
--rw-rw-rw-   0        0        0     3413 2022-12-25 16:46:43.000000 deepmimov3-0.1/README.md
--rw-rw-rw-   0        0        0       42 2024-05-10 23:31:42.392156 deepmimov3-0.1/setup.cfg
--rw-rw-rw-   0        0        0      917 2024-01-22 05:52:07.000000 deepmimov3-0.1/setup.py
-drwxrwxrwx   0        0        0        0 2024-05-10 23:31:42.359151 deepmimov3-0.1/src/
-drwxrwxrwx   0        0        0        0 2024-05-10 23:31:42.377155 deepmimov3-0.1/src/DeepMIMOv3/
--rw-rw-rw-   0        0        0      224 2024-04-13 01:59:25.000000 deepmimov3-0.1/src/DeepMIMOv3/__init__.py
--rw-rw-rw-   0        0        0     2090 2024-04-13 01:59:25.000000 deepmimov3-0.1/src/DeepMIMOv3/ant_patterns.py
--rw-rw-rw-   0        0        0    14512 2024-04-13 01:59:25.000000 deepmimov3-0.1/src/DeepMIMOv3/construct_deepmimo.py
--rw-rw-rw-   0        0        0     3467 2024-04-13 01:59:25.000000 deepmimov3-0.1/src/DeepMIMOv3/consts.py
--rw-rw-rw-   0        0        0    15091 2024-05-10 23:16:18.000000 deepmimov3-0.1/src/DeepMIMOv3/generator.py
--rw-rw-rw-   0        0        0     3128 2024-04-13 01:59:25.000000 deepmimov3-0.1/src/DeepMIMOv3/params.py
--rw-rw-rw-   0        0        0     7453 2024-04-13 01:59:25.000000 deepmimov3-0.1/src/DeepMIMOv3/raytracing_v2.py
--rw-rw-rw-   0        0        0     8454 2024-05-10 23:16:18.000000 deepmimov3-0.1/src/DeepMIMOv3/raytracing_v3.py
--rw-rw-rw-   0        0        0     5876 2024-04-13 01:59:25.000000 deepmimov3-0.1/src/DeepMIMOv3/sionna_adapter.py
--rw-rw-rw-   0        0        0     2135 2024-04-13 01:59:25.000000 deepmimov3-0.1/src/DeepMIMOv3/utils.py
--rw-rw-rw-   0        0        0     3898 2024-05-10 23:16:18.000000 deepmimov3-0.1/src/DeepMIMOv3/visualization.py
-drwxrwxrwx   0        0        0        0 2024-05-10 23:31:42.389155 deepmimov3-0.1/src/DeepMIMOv3.egg-info/
--rw-rw-rw-   0        0        0      441 2024-05-10 23:31:42.000000 deepmimov3-0.1/src/DeepMIMOv3.egg-info/PKG-INFO
--rw-rw-rw-   0        0        0      533 2024-05-10 23:31:42.000000 deepmimov3-0.1/src/DeepMIMOv3.egg-info/SOURCES.txt
--rw-rw-rw-   0        0        0        1 2024-05-10 23:31:42.000000 deepmimov3-0.1/src/DeepMIMOv3.egg-info/dependency_links.txt
--rw-rw-rw-   0        0        0       17 2024-05-10 23:31:42.000000 deepmimov3-0.1/src/DeepMIMOv3.egg-info/requires.txt
--rw-rw-rw-   0        0        0       11 2024-05-10 23:31:42.000000 deepmimov3-0.1/src/DeepMIMOv3.egg-info/top_level.txt
...
### Comparing `deepmimov3-0.1/README.md` & `deepmimov3-0.1.1/README.md`
...
### Comparing `deepmimov3-0.1/setup.py` & `deepmimov3-0.1.1/setup.py`
...
### Comparing `deepmimov3-0.1/src/DeepMIMOv3/ant_patterns.py` & `deepmimov3-0.1.1/src/DeepMIMOv3/ant_patterns.py`
...
### Comparing `deepmimov3-0.1/src/DeepMIMOv3/construct_deepmimo.py` & `deepmimov3-0.1.1/src/DeepMIMOv3/construct_deepmimo.py`
...
### Comparing `deepmimov3-0.1/src/DeepMIMOv3/consts.py` & `deepmimov3-0.1.1/src/DeepMIMOv3/consts.py`
...
### Comparing `deepmimov3-0.1/src/DeepMIMOv3/params.py` & `deepmimov3-0.1.1/src/DeepMIMOv3/params.py`
...
### Comparing `deepmimov3-0.1/src/DeepMIMOv3/raytracing_v2.py` & `deepmimov3-0.1.1/src/DeepMIMOv3/raytracing_v2.py`
...
### Comparing `deepmimov3-0.1/src/DeepMIMOv3/raytracing_v3.py` & `deepmimov3-0.1.1/src/DeepMIMOv3/raytracing_v3.py`
...
### Comparing `deepmimov3-0.1/src/DeepMIMOv3/sionna_adapter.py` & `deepmimov3-0.1.1/src/DeepMIMOv3/sionna_adapter.py`
...
### Comparing `deepmimov3-0.1/src/DeepMIMOv3/utils.py` & `deepmimov3-0.1.1/src/DeepMIMOv3/utils.py`
...
### Comparing `deepmimov3-0.1/src/DeepMIMOv3/visualization.py` & `deepmimov3-0.1.1/src/DeepMIMOv3/visualization.py`
...
### Comparing `deepmimov3-0.1/src/DeepMIMOv3.egg-info/SOURCES.txt` & `deepmimov3-0.1.1/src/DeepMIMOv3.egg-info/SOURCES.txt`
