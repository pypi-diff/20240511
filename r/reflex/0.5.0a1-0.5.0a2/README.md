# Comparing `tmp/reflex-0.5.0a1.tar.gz` & `tmp/reflex-0.5.0a2.tar.gz`
...
### Comparing `reflex-0.5.0a1/LICENSE` & `reflex-0.5.0a2/LICENSE`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/README.md` & `reflex-0.5.0a2/README.md`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/pyproject.toml` & `reflex-0.5.0a2/pyproject.toml`
...
### Comparing `reflex-0.5.0a1/reflex/.templates/apps/blank/assets/favicon.ico` & `reflex-0.5.0a2/reflex/.templates/apps/blank/assets/favicon.ico`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/.templates/apps/blank/code/blank.py` & `reflex-0.5.0a2/reflex/.templates/apps/blank/code/blank.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/.templates/apps/demo/assets/favicon.ico` & `reflex-0.5.0a2/reflex/.templates/apps/demo/assets/favicon.ico`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/.templates/apps/demo/assets/github.svg` & `reflex-0.5.0a2/reflex/.templates/apps/demo/assets/github.svg`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/.templates/apps/demo/assets/icon.svg` & `reflex-0.5.0a2/reflex/.templates/apps/demo/assets/icon.svg`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/.templates/apps/demo/assets/logo.svg` & `reflex-0.5.0a2/reflex/.templates/apps/demo/assets/logo.svg`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/.templates/apps/demo/assets/paneleft.svg` & `reflex-0.5.0a2/reflex/.templates/apps/demo/assets/paneleft.svg`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/.templates/apps/demo/code/demo.py` & `reflex-0.5.0a2/reflex/.templates/apps/demo/code/demo.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/.templates/apps/demo/code/pages/chatapp.py` & `reflex-0.5.0a2/reflex/.templates/apps/demo/code/pages/chatapp.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/.templates/apps/demo/code/pages/datatable.py` & `reflex-0.5.0a2/reflex/.templates/apps/demo/code/pages/datatable.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/.templates/apps/demo/code/pages/forms.py` & `reflex-0.5.0a2/reflex/.templates/apps/demo/code/pages/forms.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/.templates/apps/demo/code/pages/graphing.py` & `reflex-0.5.0a2/reflex/.templates/apps/demo/code/pages/graphing.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/.templates/apps/demo/code/pages/home.py` & `reflex-0.5.0a2/reflex/.templates/apps/demo/code/pages/home.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/.templates/apps/demo/code/sidebar.py` & `reflex-0.5.0a2/reflex/.templates/apps/demo/code/sidebar.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/.templates/apps/demo/code/states/form_state.py` & `reflex-0.5.0a2/reflex/.templates/apps/demo/code/states/form_state.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/.templates/apps/demo/code/states/pie_state.py` & `reflex-0.5.0a2/reflex/.templates/apps/demo/code/states/pie_state.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/.templates/apps/demo/code/styles.py` & `reflex-0.5.0a2/reflex/.templates/apps/demo/code/styles.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/.templates/apps/demo/code/webui/components/chat.py` & `reflex-0.5.0a2/reflex/.templates/apps/demo/code/webui/components/chat.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/.templates/apps/demo/code/webui/components/loading_icon.py` & `reflex-0.5.0a2/reflex/.templates/apps/demo/code/webui/components/loading_icon.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/.templates/apps/demo/code/webui/components/modal.py` & `reflex-0.5.0a2/reflex/.templates/apps/demo/code/webui/components/modal.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/.templates/apps/demo/code/webui/components/navbar.py` & `reflex-0.5.0a2/reflex/.templates/apps/demo/code/webui/components/navbar.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/.templates/apps/demo/code/webui/components/sidebar.py` & `reflex-0.5.0a2/reflex/.templates/apps/demo/code/webui/components/sidebar.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/.templates/apps/demo/code/webui/state.py` & `reflex-0.5.0a2/reflex/.templates/apps/demo/code/webui/state.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/.templates/apps/demo/code/webui/styles.py` & `reflex-0.5.0a2/reflex/.templates/apps/demo/code/webui/styles.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/.templates/jinja/custom_components/demo_app.py.jinja2` & `reflex-0.5.0a2/reflex/.templates/jinja/custom_components/demo_app.py.jinja2`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/.templates/jinja/custom_components/pyproject.toml.jinja2` & `reflex-0.5.0a2/reflex/.templates/jinja/custom_components/pyproject.toml.jinja2`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/.templates/jinja/custom_components/src.py.jinja2` & `reflex-0.5.0a2/reflex/.templates/jinja/custom_components/src.py.jinja2`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/.templates/jinja/web/package.json.jinja2` & `reflex-0.5.0a2/reflex/.templates/jinja/web/package.json.jinja2`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/.templates/jinja/web/pages/_app.js.jinja2` & `reflex-0.5.0a2/reflex/.templates/jinja/web/pages/_app.js.jinja2`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/.templates/jinja/web/pages/custom_component.js.jinja2` & `reflex-0.5.0a2/reflex/.templates/jinja/web/pages/custom_component.js.jinja2`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/.templates/jinja/web/pages/utils.js.jinja2` & `reflex-0.5.0a2/reflex/.templates/jinja/web/pages/utils.js.jinja2`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/.templates/jinja/web/utils/context.js.jinja2` & `reflex-0.5.0a2/reflex/.templates/jinja/web/utils/context.js.jinja2`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/.templates/web/components/reflex/chakra_color_mode_provider.js` & `reflex-0.5.0a2/reflex/.templates/web/components/reflex/chakra_color_mode_provider.js`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/.templates/web/components/reflex/radix_themes_color_mode_provider.js` & `reflex-0.5.0a2/reflex/.templates/web/components/reflex/radix_themes_color_mode_provider.js`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/.templates/web/utils/client_side_routing.js` & `reflex-0.5.0a2/reflex/.templates/web/utils/client_side_routing.js`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/.templates/web/utils/helpers/dataeditor.js` & `reflex-0.5.0a2/reflex/.templates/web/utils/helpers/dataeditor.js`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/.templates/web/utils/helpers/debounce.js` & `reflex-0.5.0a2/reflex/.templates/web/utils/helpers/debounce.js`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/.templates/web/utils/helpers/range.js` & `reflex-0.5.0a2/reflex/.templates/web/utils/helpers/range.js`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/.templates/web/utils/helpers/throttle.js` & `reflex-0.5.0a2/reflex/.templates/web/utils/helpers/throttle.js`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/.templates/web/utils/state.js` & `reflex-0.5.0a2/reflex/.templates/web/utils/state.js`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/__init__.py` & `reflex-0.5.0a2/reflex/__init__.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/__init__.pyi` & `reflex-0.5.0a2/reflex/__init__.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/app.py` & `reflex-0.5.0a2/reflex/app.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/app_module_for_backend.py` & `reflex-0.5.0a2/reflex/app_module_for_backend.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/base.py` & `reflex-0.5.0a2/reflex/base.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/compiler/compiler.py` & `reflex-0.5.0a2/reflex/compiler/compiler.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/compiler/templates.py` & `reflex-0.5.0a2/reflex/compiler/templates.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/compiler/utils.py` & `reflex-0.5.0a2/reflex/compiler/utils.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/__init__.py` & `reflex-0.5.0a2/reflex/components/__init__.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/base/app_wrap.py` & `reflex-0.5.0a2/reflex/components/base/app_wrap.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/base/app_wrap.pyi` & `reflex-0.5.0a2/reflex/components/base/app_wrap.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/base/bare.py` & `reflex-0.5.0a2/reflex/components/base/bare.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/base/body.pyi` & `reflex-0.5.0a2/reflex/components/base/body.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/base/document.py` & `reflex-0.5.0a2/reflex/components/base/document.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/base/document.pyi` & `reflex-0.5.0a2/reflex/components/base/document.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/base/fragment.pyi` & `reflex-0.5.0a2/reflex/components/base/fragment.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/base/head.pyi` & `reflex-0.5.0a2/reflex/components/base/head.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/base/link.py` & `reflex-0.5.0a2/reflex/components/base/link.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/base/link.pyi` & `reflex-0.5.0a2/reflex/components/base/link.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/base/meta.py` & `reflex-0.5.0a2/reflex/components/base/meta.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/base/meta.pyi` & `reflex-0.5.0a2/reflex/components/base/meta.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/base/script.py` & `reflex-0.5.0a2/reflex/components/base/script.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/base/script.pyi` & `reflex-0.5.0a2/reflex/components/base/script.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/__init__.py` & `reflex-0.5.0a2/reflex/components/chakra/__init__.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/base.py` & `reflex-0.5.0a2/reflex/components/chakra/base.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/base.pyi` & `reflex-0.5.0a2/reflex/components/chakra/base.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/datadisplay/badge.pyi` & `reflex-0.5.0a2/reflex/components/chakra/datadisplay/badge.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/datadisplay/code.pyi` & `reflex-0.5.0a2/reflex/components/chakra/datadisplay/code.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/datadisplay/divider.py` & `reflex-0.5.0a2/reflex/components/chakra/datadisplay/divider.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/datadisplay/divider.pyi` & `reflex-0.5.0a2/reflex/components/chakra/datadisplay/divider.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/datadisplay/keyboard_key.pyi` & `reflex-0.5.0a2/reflex/components/chakra/datadisplay/keyboard_key.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/datadisplay/list.py` & `reflex-0.5.0a2/reflex/components/chakra/datadisplay/list.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/datadisplay/list.pyi` & `reflex-0.5.0a2/reflex/components/chakra/datadisplay/list.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/datadisplay/stat.py` & `reflex-0.5.0a2/reflex/components/chakra/datadisplay/stat.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/datadisplay/stat.pyi` & `reflex-0.5.0a2/reflex/components/chakra/datadisplay/stat.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/datadisplay/table.py` & `reflex-0.5.0a2/reflex/components/chakra/datadisplay/table.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/datadisplay/table.pyi` & `reflex-0.5.0a2/reflex/components/chakra/datadisplay/table.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/datadisplay/tag.py` & `reflex-0.5.0a2/reflex/components/chakra/datadisplay/tag.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/datadisplay/tag.pyi` & `reflex-0.5.0a2/reflex/components/chakra/datadisplay/tag.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/disclosure/accordion.py` & `reflex-0.5.0a2/reflex/components/chakra/disclosure/accordion.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/disclosure/accordion.pyi` & `reflex-0.5.0a2/reflex/components/chakra/disclosure/accordion.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/disclosure/tabs.py` & `reflex-0.5.0a2/reflex/components/chakra/disclosure/tabs.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/disclosure/tabs.pyi` & `reflex-0.5.0a2/reflex/components/chakra/disclosure/tabs.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/disclosure/transition.py` & `reflex-0.5.0a2/reflex/components/chakra/disclosure/transition.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/disclosure/transition.pyi` & `reflex-0.5.0a2/reflex/components/chakra/disclosure/transition.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/disclosure/visuallyhidden.pyi` & `reflex-0.5.0a2/reflex/components/chakra/disclosure/visuallyhidden.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/feedback/alert.py` & `reflex-0.5.0a2/reflex/components/chakra/feedback/alert.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/feedback/alert.pyi` & `reflex-0.5.0a2/reflex/components/chakra/feedback/alert.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/feedback/circularprogress.py` & `reflex-0.5.0a2/reflex/components/chakra/feedback/circularprogress.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/feedback/circularprogress.pyi` & `reflex-0.5.0a2/reflex/components/chakra/feedback/circularprogress.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/feedback/progress.py` & `reflex-0.5.0a2/reflex/components/chakra/feedback/progress.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/feedback/progress.pyi` & `reflex-0.5.0a2/reflex/components/chakra/feedback/progress.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/feedback/skeleton.py` & `reflex-0.5.0a2/reflex/components/chakra/feedback/skeleton.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/feedback/skeleton.pyi` & `reflex-0.5.0a2/reflex/components/chakra/feedback/skeleton.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/feedback/spinner.py` & `reflex-0.5.0a2/reflex/components/chakra/feedback/spinner.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/feedback/spinner.pyi` & `reflex-0.5.0a2/reflex/components/chakra/feedback/spinner.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/forms/__init__.py` & `reflex-0.5.0a2/reflex/components/chakra/forms/__init__.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/forms/button.py` & `reflex-0.5.0a2/reflex/components/chakra/forms/button.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/forms/button.pyi` & `reflex-0.5.0a2/reflex/components/chakra/forms/button.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/forms/checkbox.py` & `reflex-0.5.0a2/reflex/components/chakra/forms/checkbox.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/forms/checkbox.pyi` & `reflex-0.5.0a2/reflex/components/chakra/forms/checkbox.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/forms/colormodeswitch.py` & `reflex-0.5.0a2/reflex/components/chakra/forms/colormodeswitch.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/forms/colormodeswitch.pyi` & `reflex-0.5.0a2/reflex/components/chakra/forms/colormodeswitch.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/forms/date_picker.pyi` & `reflex-0.5.0a2/reflex/components/chakra/forms/date_picker.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/forms/date_time_picker.pyi` & `reflex-0.5.0a2/reflex/components/chakra/forms/date_time_picker.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/forms/editable.py` & `reflex-0.5.0a2/reflex/components/chakra/forms/editable.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/forms/editable.pyi` & `reflex-0.5.0a2/reflex/components/chakra/forms/editable.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/forms/email.pyi` & `reflex-0.5.0a2/reflex/components/chakra/forms/email.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/forms/form.py` & `reflex-0.5.0a2/reflex/components/chakra/forms/form.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/forms/form.pyi` & `reflex-0.5.0a2/reflex/components/chakra/forms/form.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/forms/iconbutton.py` & `reflex-0.5.0a2/reflex/components/chakra/forms/iconbutton.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/forms/iconbutton.pyi` & `reflex-0.5.0a2/reflex/components/chakra/forms/iconbutton.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/forms/input.py` & `reflex-0.5.0a2/reflex/components/chakra/forms/input.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/forms/input.pyi` & `reflex-0.5.0a2/reflex/components/chakra/forms/input.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/forms/multiselect.py` & `reflex-0.5.0a2/reflex/components/chakra/forms/multiselect.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/forms/numberinput.py` & `reflex-0.5.0a2/reflex/components/chakra/forms/numberinput.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/forms/numberinput.pyi` & `reflex-0.5.0a2/reflex/components/chakra/forms/numberinput.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/forms/password.pyi` & `reflex-0.5.0a2/reflex/components/chakra/forms/password.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/forms/pininput.py` & `reflex-0.5.0a2/reflex/components/chakra/forms/pininput.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/forms/pininput.pyi` & `reflex-0.5.0a2/reflex/components/chakra/forms/pininput.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/forms/radio.py` & `reflex-0.5.0a2/reflex/components/chakra/forms/radio.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/forms/radio.pyi` & `reflex-0.5.0a2/reflex/components/chakra/forms/radio.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/forms/rangeslider.py` & `reflex-0.5.0a2/reflex/components/chakra/forms/rangeslider.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/forms/rangeslider.pyi` & `reflex-0.5.0a2/reflex/components/chakra/forms/rangeslider.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/forms/select.py` & `reflex-0.5.0a2/reflex/components/chakra/forms/select.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/forms/select.pyi` & `reflex-0.5.0a2/reflex/components/chakra/forms/select.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/forms/slider.py` & `reflex-0.5.0a2/reflex/components/chakra/forms/slider.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/forms/slider.pyi` & `reflex-0.5.0a2/reflex/components/chakra/forms/slider.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/forms/switch.py` & `reflex-0.5.0a2/reflex/components/chakra/forms/switch.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/forms/switch.pyi` & `reflex-0.5.0a2/reflex/components/chakra/forms/switch.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/forms/textarea.py` & `reflex-0.5.0a2/reflex/components/chakra/forms/textarea.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/forms/textarea.pyi` & `reflex-0.5.0a2/reflex/components/chakra/forms/textarea.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/forms/time_picker.pyi` & `reflex-0.5.0a2/reflex/components/chakra/forms/time_picker.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/layout/aspect_ratio.pyi` & `reflex-0.5.0a2/reflex/components/chakra/layout/aspect_ratio.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/layout/box.py` & `reflex-0.5.0a2/reflex/components/chakra/layout/box.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/layout/box.pyi` & `reflex-0.5.0a2/reflex/components/chakra/layout/box.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/layout/card.py` & `reflex-0.5.0a2/reflex/components/chakra/layout/card.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/layout/card.pyi` & `reflex-0.5.0a2/reflex/components/chakra/layout/card.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/layout/center.pyi` & `reflex-0.5.0a2/reflex/components/chakra/layout/center.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/layout/container.pyi` & `reflex-0.5.0a2/reflex/components/chakra/layout/container.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/layout/flex.py` & `reflex-0.5.0a2/reflex/components/chakra/layout/flex.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/layout/flex.pyi` & `reflex-0.5.0a2/reflex/components/chakra/layout/flex.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/layout/grid.py` & `reflex-0.5.0a2/reflex/components/chakra/layout/grid.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/layout/grid.pyi` & `reflex-0.5.0a2/reflex/components/chakra/layout/grid.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/layout/spacer.pyi` & `reflex-0.5.0a2/reflex/components/chakra/layout/spacer.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/layout/stack.py` & `reflex-0.5.0a2/reflex/components/chakra/layout/stack.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/layout/stack.pyi` & `reflex-0.5.0a2/reflex/components/chakra/layout/stack.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/layout/wrap.py` & `reflex-0.5.0a2/reflex/components/chakra/layout/wrap.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/layout/wrap.pyi` & `reflex-0.5.0a2/reflex/components/chakra/layout/wrap.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/media/avatar.py` & `reflex-0.5.0a2/reflex/components/chakra/media/avatar.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/media/avatar.pyi` & `reflex-0.5.0a2/reflex/components/chakra/media/avatar.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/media/icon.py` & `reflex-0.5.0a2/reflex/components/chakra/media/icon.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/media/icon.pyi` & `reflex-0.5.0a2/reflex/components/chakra/media/icon.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/media/image.py` & `reflex-0.5.0a2/reflex/components/chakra/media/image.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/media/image.pyi` & `reflex-0.5.0a2/reflex/components/chakra/media/image.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/navigation/breadcrumb.py` & `reflex-0.5.0a2/reflex/components/chakra/navigation/breadcrumb.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/navigation/breadcrumb.pyi` & `reflex-0.5.0a2/reflex/components/chakra/navigation/breadcrumb.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/navigation/link.py` & `reflex-0.5.0a2/reflex/components/chakra/navigation/link.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/navigation/link.pyi` & `reflex-0.5.0a2/reflex/components/chakra/navigation/link.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/navigation/linkoverlay.py` & `reflex-0.5.0a2/reflex/components/chakra/navigation/linkoverlay.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/navigation/linkoverlay.pyi` & `reflex-0.5.0a2/reflex/components/chakra/navigation/linkoverlay.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/navigation/stepper.py` & `reflex-0.5.0a2/reflex/components/chakra/navigation/stepper.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/navigation/stepper.pyi` & `reflex-0.5.0a2/reflex/components/chakra/navigation/stepper.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/overlay/__init__.py` & `reflex-0.5.0a2/reflex/components/chakra/overlay/__init__.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/overlay/alertdialog.py` & `reflex-0.5.0a2/reflex/components/chakra/overlay/alertdialog.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/overlay/alertdialog.pyi` & `reflex-0.5.0a2/reflex/components/chakra/overlay/alertdialog.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/overlay/drawer.py` & `reflex-0.5.0a2/reflex/components/chakra/overlay/drawer.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/overlay/drawer.pyi` & `reflex-0.5.0a2/reflex/components/chakra/overlay/drawer.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/overlay/menu.py` & `reflex-0.5.0a2/reflex/components/chakra/overlay/menu.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/overlay/menu.pyi` & `reflex-0.5.0a2/reflex/components/chakra/overlay/menu.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/overlay/modal.py` & `reflex-0.5.0a2/reflex/components/chakra/overlay/modal.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/overlay/modal.pyi` & `reflex-0.5.0a2/reflex/components/chakra/overlay/modal.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/overlay/popover.py` & `reflex-0.5.0a2/reflex/components/chakra/overlay/popover.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/overlay/popover.pyi` & `reflex-0.5.0a2/reflex/components/chakra/overlay/popover.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/overlay/tooltip.py` & `reflex-0.5.0a2/reflex/components/chakra/overlay/tooltip.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/overlay/tooltip.pyi` & `reflex-0.5.0a2/reflex/components/chakra/overlay/tooltip.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/typography/heading.pyi` & `reflex-0.5.0a2/reflex/components/chakra/typography/heading.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/typography/highlight.py` & `reflex-0.5.0a2/reflex/components/chakra/typography/highlight.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/typography/highlight.pyi` & `reflex-0.5.0a2/reflex/components/chakra/typography/highlight.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/typography/span.pyi` & `reflex-0.5.0a2/reflex/components/chakra/typography/span.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/chakra/typography/text.pyi` & `reflex-0.5.0a2/reflex/components/chakra/typography/text.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/component.py` & `reflex-0.5.0a2/reflex/components/component.py`
...
### Comparing `reflex-0.5.0a1/reflex/components/core/__init__.py` & `reflex-0.5.0a2/reflex/components/core/__init__.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/core/banner.py` & `reflex-0.5.0a2/reflex/components/core/banner.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/core/banner.pyi` & `reflex-0.5.0a2/reflex/components/core/banner.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/core/client_side_routing.py` & `reflex-0.5.0a2/reflex/components/core/client_side_routing.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/core/client_side_routing.pyi` & `reflex-0.5.0a2/reflex/components/core/client_side_routing.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/core/colors.py` & `reflex-0.5.0a2/reflex/components/core/colors.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/core/cond.py` & `reflex-0.5.0a2/reflex/components/core/cond.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/core/debounce.py` & `reflex-0.5.0a2/reflex/components/core/debounce.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/core/debounce.pyi` & `reflex-0.5.0a2/reflex/components/core/debounce.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/core/html.py` & `reflex-0.5.0a2/reflex/components/core/html.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/core/html.pyi` & `reflex-0.5.0a2/reflex/components/core/html.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/core/match.py` & `reflex-0.5.0a2/reflex/components/core/match.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/core/responsive.py` & `reflex-0.5.0a2/reflex/components/core/responsive.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/core/upload.py` & `reflex-0.5.0a2/reflex/components/core/upload.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/core/upload.pyi` & `reflex-0.5.0a2/reflex/components/core/upload.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/datadisplay/code.py` & `reflex-0.5.0a2/reflex/components/datadisplay/code.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/datadisplay/code.pyi` & `reflex-0.5.0a2/reflex/components/datadisplay/code.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/datadisplay/dataeditor.py` & `reflex-0.5.0a2/reflex/components/datadisplay/dataeditor.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/datadisplay/dataeditor.pyi` & `reflex-0.5.0a2/reflex/components/datadisplay/dataeditor.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/datadisplay/logo.py` & `reflex-0.5.0a2/reflex/components/datadisplay/logo.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/el/constants/html.py` & `reflex-0.5.0a2/reflex/components/el/constants/html.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/el/constants/react.py` & `reflex-0.5.0a2/reflex/components/el/constants/react.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/el/constants/reflex.py` & `reflex-0.5.0a2/reflex/components/el/constants/reflex.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/el/element.pyi` & `reflex-0.5.0a2/reflex/components/el/element.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/el/elements/__init__.py` & `reflex-0.5.0a2/reflex/components/el/elements/__init__.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/el/elements/base.py` & `reflex-0.5.0a2/reflex/components/el/elements/base.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/el/elements/base.pyi` & `reflex-0.5.0a2/reflex/components/el/elements/base.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/el/elements/forms.py` & `reflex-0.5.0a2/reflex/components/el/elements/forms.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/el/elements/forms.pyi` & `reflex-0.5.0a2/reflex/components/el/elements/forms.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/el/elements/inline.py` & `reflex-0.5.0a2/reflex/components/el/elements/inline.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/el/elements/inline.pyi` & `reflex-0.5.0a2/reflex/components/el/elements/inline.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/el/elements/media.py` & `reflex-0.5.0a2/reflex/components/el/elements/media.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/el/elements/media.pyi` & `reflex-0.5.0a2/reflex/components/el/elements/media.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/el/elements/metadata.py` & `reflex-0.5.0a2/reflex/components/el/elements/metadata.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/el/elements/metadata.pyi` & `reflex-0.5.0a2/reflex/components/el/elements/metadata.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/el/elements/other.py` & `reflex-0.5.0a2/reflex/components/el/elements/other.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/el/elements/other.pyi` & `reflex-0.5.0a2/reflex/components/el/elements/other.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/el/elements/scripts.py` & `reflex-0.5.0a2/reflex/components/el/elements/scripts.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/el/elements/scripts.pyi` & `reflex-0.5.0a2/reflex/components/el/elements/scripts.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/el/elements/sectioning.py` & `reflex-0.5.0a2/reflex/components/el/elements/sectioning.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/el/elements/sectioning.pyi` & `reflex-0.5.0a2/reflex/components/el/elements/sectioning.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/el/elements/tables.py` & `reflex-0.5.0a2/reflex/components/el/elements/tables.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/el/elements/tables.pyi` & `reflex-0.5.0a2/reflex/components/el/elements/tables.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/el/elements/typography.py` & `reflex-0.5.0a2/reflex/components/el/elements/typography.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/el/elements/typography.pyi` & `reflex-0.5.0a2/reflex/components/el/elements/typography.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/gridjs/datatable.py` & `reflex-0.5.0a2/reflex/components/gridjs/datatable.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/gridjs/datatable.pyi` & `reflex-0.5.0a2/reflex/components/gridjs/datatable.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/lucide/icon.py` & `reflex-0.5.0a2/reflex/components/lucide/icon.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/lucide/icon.pyi` & `reflex-0.5.0a2/reflex/components/lucide/icon.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/markdown/markdown.py` & `reflex-0.5.0a2/reflex/components/markdown/markdown.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/markdown/markdown.pyi` & `reflex-0.5.0a2/reflex/components/markdown/markdown.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/moment/moment.py` & `reflex-0.5.0a2/reflex/components/moment/moment.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/moment/moment.pyi` & `reflex-0.5.0a2/reflex/components/moment/moment.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/next/base.pyi` & `reflex-0.5.0a2/reflex/components/next/base.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/next/image.py` & `reflex-0.5.0a2/reflex/components/next/image.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/next/image.pyi` & `reflex-0.5.0a2/reflex/components/next/image.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/next/link.pyi` & `reflex-0.5.0a2/reflex/components/next/link.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/next/video.py` & `reflex-0.5.0a2/reflex/components/next/video.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/next/video.pyi` & `reflex-0.5.0a2/reflex/components/next/video.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/plotly/plotly.py` & `reflex-0.5.0a2/reflex/components/plotly/plotly.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/plotly/plotly.pyi` & `reflex-0.5.0a2/reflex/components/plotly/plotly.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/primitives/accordion.py` & `reflex-0.5.0a2/reflex/components/radix/primitives/accordion.py`
...
### Comparing `reflex-0.5.0a1/reflex/components/radix/primitives/accordion.pyi` & `reflex-0.5.0a2/reflex/components/radix/primitives/accordion.pyi`
...
### Comparing `reflex-0.5.0a1/reflex/components/radix/primitives/base.py` & `reflex-0.5.0a2/reflex/components/radix/primitives/base.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/primitives/base.pyi` & `reflex-0.5.0a2/reflex/components/radix/primitives/base.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/primitives/drawer.py` & `reflex-0.5.0a2/reflex/components/radix/primitives/drawer.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/primitives/drawer.pyi` & `reflex-0.5.0a2/reflex/components/radix/primitives/drawer.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/primitives/form.py` & `reflex-0.5.0a2/reflex/components/radix/primitives/form.py`
...
### Comparing `reflex-0.5.0a1/reflex/components/radix/primitives/form.pyi` & `reflex-0.5.0a2/reflex/components/radix/primitives/form.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/primitives/progress.py` & `reflex-0.5.0a2/reflex/components/radix/primitives/progress.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/primitives/progress.pyi` & `reflex-0.5.0a2/reflex/components/radix/primitives/progress.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/primitives/slider.py` & `reflex-0.5.0a2/reflex/components/radix/primitives/slider.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/primitives/slider.pyi` & `reflex-0.5.0a2/reflex/components/radix/primitives/slider.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/base.py` & `reflex-0.5.0a2/reflex/components/radix/themes/base.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/base.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/base.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/color_mode.py` & `reflex-0.5.0a2/reflex/components/radix/themes/color_mode.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/color_mode.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/color_mode.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/__init__.py` & `reflex-0.5.0a2/reflex/components/radix/themes/components/__init__.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/alert_dialog.py` & `reflex-0.5.0a2/reflex/components/radix/themes/components/alert_dialog.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/alert_dialog.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/components/alert_dialog.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/aspect_ratio.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/components/aspect_ratio.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/avatar.py` & `reflex-0.5.0a2/reflex/components/radix/themes/components/avatar.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/avatar.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/components/avatar.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/badge.py` & `reflex-0.5.0a2/reflex/components/radix/themes/components/badge.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/badge.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/components/badge.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/button.py` & `reflex-0.5.0a2/reflex/components/radix/themes/components/button.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/button.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/components/button.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/callout.py` & `reflex-0.5.0a2/reflex/components/radix/themes/components/callout.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/callout.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/components/callout.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/card.py` & `reflex-0.5.0a2/reflex/components/radix/themes/components/card.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/card.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/components/card.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/checkbox.py` & `reflex-0.5.0a2/reflex/components/radix/themes/components/checkbox.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/checkbox.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/components/checkbox.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/checkbox_cards.py` & `reflex-0.5.0a2/reflex/components/radix/themes/components/checkbox_cards.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/checkbox_cards.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/components/checkbox_cards.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/checkbox_group.py` & `reflex-0.5.0a2/reflex/components/radix/themes/components/checkbox_group.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/checkbox_group.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/components/checkbox_group.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/context_menu.py` & `reflex-0.5.0a2/reflex/components/radix/themes/components/context_menu.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/context_menu.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/components/context_menu.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/data_list.py` & `reflex-0.5.0a2/reflex/components/radix/themes/components/data_list.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/data_list.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/components/data_list.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/dialog.py` & `reflex-0.5.0a2/reflex/components/radix/themes/components/dialog.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/dialog.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/components/dialog.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/dropdown_menu.py` & `reflex-0.5.0a2/reflex/components/radix/themes/components/dropdown_menu.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/dropdown_menu.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/components/dropdown_menu.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/hover_card.py` & `reflex-0.5.0a2/reflex/components/radix/themes/components/hover_card.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/hover_card.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/components/hover_card.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/icon_button.py` & `reflex-0.5.0a2/reflex/components/radix/themes/components/icon_button.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/icon_button.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/components/icon_button.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/inset.py` & `reflex-0.5.0a2/reflex/components/radix/themes/components/inset.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/inset.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/components/inset.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/popover.py` & `reflex-0.5.0a2/reflex/components/radix/themes/components/popover.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/popover.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/components/popover.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/progress.py` & `reflex-0.5.0a2/reflex/components/radix/themes/components/progress.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/progress.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/components/progress.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/radio.py` & `reflex-0.5.0a2/reflex/components/radix/themes/components/radio.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/radio.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/components/radio.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/radio_cards.py` & `reflex-0.5.0a2/reflex/components/radix/themes/components/radio_cards.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/radio_cards.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/components/radio_cards.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/radio_group.py` & `reflex-0.5.0a2/reflex/components/radix/themes/components/radio_group.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/radio_group.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/components/radio_group.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/scroll_area.py` & `reflex-0.5.0a2/reflex/components/radix/themes/components/scroll_area.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/scroll_area.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/components/scroll_area.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/segmented_control.py` & `reflex-0.5.0a2/reflex/components/radix/themes/components/segmented_control.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/segmented_control.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/components/segmented_control.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/select.py` & `reflex-0.5.0a2/reflex/components/radix/themes/components/select.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/select.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/components/select.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/separator.py` & `reflex-0.5.0a2/reflex/components/radix/themes/components/separator.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/separator.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/components/separator.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/skeleton.py` & `reflex-0.5.0a2/reflex/components/radix/themes/components/skeleton.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/skeleton.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/components/skeleton.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/slider.py` & `reflex-0.5.0a2/reflex/components/radix/themes/components/slider.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/slider.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/components/slider.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/spinner.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/components/spinner.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/switch.py` & `reflex-0.5.0a2/reflex/components/radix/themes/components/switch.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/switch.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/components/switch.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/table.py` & `reflex-0.5.0a2/reflex/components/radix/themes/components/table.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/table.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/components/table.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/tabs.py` & `reflex-0.5.0a2/reflex/components/radix/themes/components/tabs.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/tabs.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/components/tabs.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/text_area.py` & `reflex-0.5.0a2/reflex/components/radix/themes/components/text_area.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/text_area.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/components/text_area.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/text_field.py` & `reflex-0.5.0a2/reflex/components/radix/themes/components/text_field.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/text_field.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/components/text_field.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/tooltip.py` & `reflex-0.5.0a2/reflex/components/radix/themes/components/tooltip.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/components/tooltip.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/components/tooltip.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/layout/__init__.py` & `reflex-0.5.0a2/reflex/components/radix/themes/layout/__init__.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/layout/base.py` & `reflex-0.5.0a2/reflex/components/radix/themes/layout/base.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/layout/base.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/layout/base.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/layout/box.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/layout/box.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/layout/center.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/layout/center.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/layout/container.py` & `reflex-0.5.0a2/reflex/components/radix/themes/layout/container.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/layout/container.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/layout/container.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/layout/flex.py` & `reflex-0.5.0a2/reflex/components/radix/themes/layout/flex.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/layout/flex.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/layout/flex.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/layout/grid.py` & `reflex-0.5.0a2/reflex/components/radix/themes/layout/grid.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/layout/grid.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/layout/grid.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/layout/list.py` & `reflex-0.5.0a2/reflex/components/radix/themes/layout/list.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/layout/list.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/layout/list.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/layout/section.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/layout/section.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/layout/spacer.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/layout/spacer.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/layout/stack.py` & `reflex-0.5.0a2/reflex/components/radix/themes/layout/stack.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/layout/stack.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/layout/stack.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/typography/blockquote.py` & `reflex-0.5.0a2/reflex/components/radix/themes/typography/blockquote.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/typography/blockquote.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/typography/blockquote.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/typography/code.py` & `reflex-0.5.0a2/reflex/components/radix/themes/typography/code.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/typography/code.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/typography/code.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/typography/heading.py` & `reflex-0.5.0a2/reflex/components/radix/themes/typography/heading.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/typography/heading.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/typography/heading.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/typography/link.py` & `reflex-0.5.0a2/reflex/components/radix/themes/typography/link.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/typography/link.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/typography/link.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/typography/text.py` & `reflex-0.5.0a2/reflex/components/radix/themes/typography/text.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/radix/themes/typography/text.pyi` & `reflex-0.5.0a2/reflex/components/radix/themes/typography/text.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/react_player/audio.pyi` & `reflex-0.5.0a2/reflex/components/react_player/audio.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/react_player/react_player.py` & `reflex-0.5.0a2/reflex/components/react_player/react_player.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/react_player/react_player.pyi` & `reflex-0.5.0a2/reflex/components/react_player/react_player.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/react_player/video.pyi` & `reflex-0.5.0a2/reflex/components/react_player/video.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/recharts/__init__.py` & `reflex-0.5.0a2/reflex/components/recharts/__init__.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/recharts/cartesian.py` & `reflex-0.5.0a2/reflex/components/recharts/cartesian.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/recharts/cartesian.pyi` & `reflex-0.5.0a2/reflex/components/recharts/cartesian.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/recharts/charts.py` & `reflex-0.5.0a2/reflex/components/recharts/charts.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/recharts/charts.pyi` & `reflex-0.5.0a2/reflex/components/recharts/charts.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/recharts/general.py` & `reflex-0.5.0a2/reflex/components/recharts/general.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/recharts/general.pyi` & `reflex-0.5.0a2/reflex/components/recharts/general.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/recharts/polar.py` & `reflex-0.5.0a2/reflex/components/recharts/polar.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/recharts/polar.pyi` & `reflex-0.5.0a2/reflex/components/recharts/polar.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/recharts/recharts.py` & `reflex-0.5.0a2/reflex/components/recharts/recharts.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/recharts/recharts.pyi` & `reflex-0.5.0a2/reflex/components/recharts/recharts.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/sonner/toast.py` & `reflex-0.5.0a2/reflex/components/sonner/toast.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/sonner/toast.pyi` & `reflex-0.5.0a2/reflex/components/sonner/toast.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/suneditor/editor.py` & `reflex-0.5.0a2/reflex/components/suneditor/editor.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/suneditor/editor.pyi` & `reflex-0.5.0a2/reflex/components/suneditor/editor.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/tags/iter_tag.py` & `reflex-0.5.0a2/reflex/components/tags/iter_tag.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/tags/tag.py` & `reflex-0.5.0a2/reflex/components/tags/tag.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/components/tags/tagless.py` & `reflex-0.5.0a2/reflex/components/tags/tagless.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/config.py` & `reflex-0.5.0a2/reflex/config.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/config.pyi` & `reflex-0.5.0a2/reflex/config.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/constants/__init__.py` & `reflex-0.5.0a2/reflex/constants/__init__.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/constants/base.py` & `reflex-0.5.0a2/reflex/constants/base.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/constants/base.pyi` & `reflex-0.5.0a2/reflex/constants/base.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/constants/colors.py` & `reflex-0.5.0a2/reflex/constants/colors.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/constants/compiler.py` & `reflex-0.5.0a2/reflex/constants/compiler.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/constants/config.py` & `reflex-0.5.0a2/reflex/constants/config.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/constants/custom_components.py` & `reflex-0.5.0a2/reflex/constants/custom_components.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/constants/event.py` & `reflex-0.5.0a2/reflex/constants/event.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/constants/installer.py` & `reflex-0.5.0a2/reflex/constants/installer.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/constants/route.py` & `reflex-0.5.0a2/reflex/constants/route.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/constants/style.py` & `reflex-0.5.0a2/reflex/constants/style.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/custom_components/custom_components.py` & `reflex-0.5.0a2/reflex/custom_components/custom_components.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/event.py` & `reflex-0.5.0a2/reflex/event.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/experimental/__init__.py` & `reflex-0.5.0a2/reflex/experimental/__init__.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/experimental/hooks.py` & `reflex-0.5.0a2/reflex/experimental/hooks.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/experimental/layout.py` & `reflex-0.5.0a2/reflex/experimental/layout.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/middleware/hydrate_middleware.py` & `reflex-0.5.0a2/reflex/middleware/hydrate_middleware.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/middleware/middleware.py` & `reflex-0.5.0a2/reflex/middleware/middleware.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/model.py` & `reflex-0.5.0a2/reflex/model.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/page.py` & `reflex-0.5.0a2/reflex/page.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/reflex.py` & `reflex-0.5.0a2/reflex/reflex.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/route.py` & `reflex-0.5.0a2/reflex/route.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/state.py` & `reflex-0.5.0a2/reflex/state.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/style.py` & `reflex-0.5.0a2/reflex/style.py`
...
### Comparing `reflex-0.5.0a1/reflex/testing.py` & `reflex-0.5.0a2/reflex/testing.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/utils/build.py` & `reflex-0.5.0a2/reflex/utils/build.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/utils/compat.py` & `reflex-0.5.0a2/reflex/utils/compat.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/utils/console.py` & `reflex-0.5.0a2/reflex/utils/console.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/utils/exec.py` & `reflex-0.5.0a2/reflex/utils/exec.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/utils/export.py` & `reflex-0.5.0a2/reflex/utils/export.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/utils/format.py` & `reflex-0.5.0a2/reflex/utils/format.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/utils/imports.py` & `reflex-0.5.0a2/reflex/utils/imports.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/utils/path_ops.py` & `reflex-0.5.0a2/reflex/utils/path_ops.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/utils/prerequisites.py` & `reflex-0.5.0a2/reflex/utils/prerequisites.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/utils/processes.py` & `reflex-0.5.0a2/reflex/utils/processes.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/utils/pyi_generator.py` & `reflex-0.5.0a2/reflex/utils/pyi_generator.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/utils/serializers.py` & `reflex-0.5.0a2/reflex/utils/serializers.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/utils/telemetry.py` & `reflex-0.5.0a2/reflex/utils/telemetry.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/utils/types.py` & `reflex-0.5.0a2/reflex/utils/types.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/utils/watch.py` & `reflex-0.5.0a2/reflex/utils/watch.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/vars.py` & `reflex-0.5.0a2/reflex/vars.py`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/reflex/vars.pyi` & `reflex-0.5.0a2/reflex/vars.pyi`

 * *Files identical despite different names*

### Comparing `reflex-0.5.0a1/PKG-INFO` & `reflex-0.5.0a2/PKG-INFO`
